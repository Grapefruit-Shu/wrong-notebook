...
async function testMaxTokensWithLongPrompt() {
    console.log("=== 测试长 prompt + 大 max_tokens ===");
...
在此处填写难度等级，必须是以下之一："easy", "medium", "hard", "harder"。
    ...
    const testValues = [1024, 1500, 2000, 2048];
...
testMaxTokensWithLongPrompt().catch(console.error);
